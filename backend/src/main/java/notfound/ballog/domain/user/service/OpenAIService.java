...
public class OpenAIService {
    ...
    private String createStructuredPrompt(String prompt) {
        return prompt + "\n\n다음과 같은 JSON 구조로 응답해주세요:\n" +
                "{\n" +
                "  \"analysis\": \"플레이 스타일 분석 내용 (유저 이름을 사용하여 작성, 이름 뒤에 님을 붙여서 작성해주세요. {예 : 플레이어님})\",\n" +
                "  \"recommendedPlayer\": \n" +
                "    {\n" +
                "      \"name\": \"선수 이름 (해외 선수도 이름을 한글로 번역해서 보여주세요.)\",\n" +
                "      \"position\": \"포지션 (영어로 작성해주세요. {예 : FW, CM, WB, CB, LW, RW 등등})\",\n" +
                "      \"style\": \"위 analysis 부분을 한글로 한 문장으로 요약해주세요.\",\n" +
                "      \"reason\": \"추천한 축구 선수와 유사한 이유 (유저 이름을 사용하여 작성, 이름 뒤에 님을 붙여서 작성해주세요. {예 : 플레이어님})\"\n" +
